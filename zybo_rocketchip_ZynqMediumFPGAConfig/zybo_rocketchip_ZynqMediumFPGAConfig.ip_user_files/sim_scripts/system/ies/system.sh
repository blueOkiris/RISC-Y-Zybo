...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../zybo_rocketchip_ZynqMediumFPGAConfig.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../zybo_rocketchip_ZynqMediumFPGAConfig.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../zybo_rocketchip_ZynqMediumFPGAConfig.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../zybo_rocketchip_ZynqMediumFPGAConfig.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../zybo_rocketchip_ZynqMediumFPGAConfig.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
       +incdir+"/home/dylan/Xilinx/Vivado/2018.3/data/xilinx_vip/include"
}
