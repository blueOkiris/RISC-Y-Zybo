...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/dylan/MEGA/Documents/School/2020-21/ECE/530/RISC-Y-Zybo/zybo_rocketchip_ZynqMediumFPGAConfig/zybo_rocketchip_ZynqMediumFPGAConfig.cache/compile_simlib/questa"
  fi
