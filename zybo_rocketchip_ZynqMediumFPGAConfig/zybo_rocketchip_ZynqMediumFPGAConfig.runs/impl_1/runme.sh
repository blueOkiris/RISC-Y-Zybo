...
HD_PWD='/home/dylan/MEGA/Documents/School/2020-21/ECE/530/RISC-Y-Zybo/fpga-zynq/zybo/zybo_rocketchip_ZynqMediumFPGAConfig/zybo_rocketchip_ZynqMediumFPGAConfig.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rocketchip_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source rocketchip_wrapper.tcl -notrace
